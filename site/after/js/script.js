...
var categoryHtml = "snippet/catgory-snippet.html";
var menuItemsUrl =
...
// from the server
function buildAndShowCategoriesHTML (caytegories) {
...
// Using castegories data and snippets html
...
function buildMenuItemViewHtml(categoryMenuItems,
								menuItemsTitleHtml,
								menuItemHtml) {
	menuItemsTitleHtml = 
...
// Appends prices with '$' if price exists
